#ifndef INCLUDED_asteroid_H  //include-guard
#define INCLUDED_asteroid_H  //include-guard
...
#define DIRECTORY ../data/Interaction_5Myr_1Hill_group/N100_1/  //ファイル保存用のディレクトリ
#define _STR(str) #str
